...
function chooseField(string){
  switch(string) {
        case "3x3":
            return loadFieldFromJSON(string);
            break;
        case "4x4":
            return loadFieldFromJSON(string);
            break;
        default:
            alert("We're sorry: Only 3x3 or 4x4 field is implemented!");
            break;
    }
}
...
function loadFieldFromJSON(string){
  ...
  //   }
  // }); 
  $.getJSON( "three.json", function( data ) {
    console.log(data.d);
  });
}
